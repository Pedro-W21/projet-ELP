...
func demande_filtre(reader io.Reader, request_id int) Filter {
	var filtre string
	texte2 := fmt.Sprintf("\nEntrez le filtre que vous voulez appliquer à l'image %d. Vous avez le choix entre : \n1. Le filtre Gaussien: dans ce cas tapez Gaussien\n2. Le filtre négatif: dans ce cas tapez Negatif\n3. Le fondu négatif: dans ce cas tapez Neg_Fondu\n4. Augmenter la froideur: dans ce cas tapez Froid\n5. Augmenter la chaleur: dans ce cas tapez Chaud\n6. Augmenter la luminosité: dans ce cas tapez Luminosite\n7. Appliquer un flou moyen: dans ce cas tapez Flou_moy\n8. Appliquer un flou fondu: dans ce cas tapez Flou_fondu\n9. Faire un jeu de la vie avec l'image (il faut que l'image soit en noir et blanc dans ce cas!!): dans ce cas tapez Jeu_Vie\n10.Faire la transformée de Fourier discrète 2D de l'image (l'image doit être en échelle de gris): dans ce cas tapez Fourier\n", request_id)
	...
	} else if filtre == "Fourier" {
		structFiltre = Fourier{}
	} else {
